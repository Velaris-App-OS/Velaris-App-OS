"""Protocol interface for event_bus backends.

Implement this Protocol and register via entry_points:

    [project.entry-points."helix.event_bus"]
...
@runtime_checkable
class Event_busBackend(Protocol):
    """event_bus backend interface. All methods must be implemented."""
