"""Protocol interface for importer backends.

Implement this Protocol and register via entry_points:

    [project.entry-points."helix.importer"]
...
@runtime_checkable
class ImporterBackend(Protocol):
    """importer backend interface. All methods must be implemented."""
