...
MODULES = [
    ...
    },
    {
        ...
        "path": "/cases",
        "label": "Cases",
        # HxMeet (phase 66) lives as the HxMeet tab inside the case view —
        # real-time sessions, live captions, and sealed recordings/transcripts.
        "description": "Browse, create, and manage case instances — including HxMeet real-time case sessions (embedded video, live captions, consent-gated sealed recordings and transcripts).",
        "phase": 3,
        "dev_time": "3 days",
        "api_endpoints": ["/api/v1/cases", "/api/v1/meet"],
        "ai_dependency": "none",
    },
    {
        "category": "Cases",
    ...
    },
    {
        ...
        # HxEvolve lives as the Insights tab inside Process Mining.
        "description": "Discover actual flows, find bottlenecks, and check conformance — including HxEvolve drift detection (mine deviations, propose gated process changes, prove them via replay before a human merges).",
        "phase": 14,
        "dev_time": "3 days",
        "api_endpoints": ["/api/v1/process-mining", "/api/v1/hxevolve"],
        "ai_dependency": "none",
    },
    {
        "category": "Cases",
        "path": "/hxreplay",
        "label": "HxReplay",
        "description": "Counterfactual case replay — fork real history at a decision point, run cohort what-ifs with labelled determinacy coverage, and cost the deltas (Case Costing: rate cards, timers, billing export).",
        "phase": 51,
        "dev_time": "4 days",
        "api_endpoints": ["/api/v1/hxreplay", "/api/v1/costing"],
        "ai_dependency": "none",
    },
    {
        "category": "Cases",
        "path": "/hxdbmigrate",
        "label": "HxDBMigrate",
        "description": "Connect a legacy source database, analyze its schema (Schema Autobiography, data-quality scoring), generate case types from workflow tables, sync with row-links identity spine, one-click cutover with rollback window, and a signed Compliance Migration Certificate.",
        "phase": 50,
        "dev_time": "5 days",
        "api_endpoints": ["/api/v1/hxdbmigrate"],
    ...
    },
    {
        ...
        "path": "/scout-ai",
        "label": "Scout AI",
        "description": "AI-powered deep code analysis. Understands legacy code and auto-generates Velaris ports.",
        "phase": 19,
        "dev_time": "3 days",
    ...
    },
    {
        ...
        "path": "/hxnexus",
        "label": "HxNexus",
        # HxDraft (draft-first config changes) and the HxNexus Operator (MCP
        # tool surface for external agents) live under the HxNexus umbrella.
        "description": "AI-powered case suggestions, document Q&A, case-scoped ask-the-case (sovereignty-first: per-tenant local/external choice), conversational assistant, HxDraft draft-first configuration changes, and the HxNexus Operator MCP tool surface for external agents (scoped tokens, human-confirm proposals).",
        "phase": 30,
        "dev_time": "5 days",
        "api_endpoints": ["/api/v1/hxnexus/chat", "/api/v1/hxnexus/cases/{id}/suggest", "/api/v1/hxnexus/cases/{id}/qa", "/api/v1/hxnexus/cases/{id}/ask", "/api/v1/hxnexus/draft", "/api/v1/mcp"],
        "ai_dependency": "required",
    },
    {
        "category": "Admin",
        "path": "/marketplace",
        "label": "Marketplace",
        "description": "Install marketplace apps and connector packages — tier from the registry (official/verified/community), out-of-process execution only, capability-grant approvals, workspace whitelists, and release review queue.",
        "phase": 64,
        "dev_time": "5 days",
        "api_endpoints": ["/api/v1/marketplace"],
        "ai_dependency": "none",
    },
    {
        "category": "Admin",
    ...
    },
    {
        ...
        "description": "Configure tenant portals, enable case types for public submission, view submissions. Portal v2: customer accounts spine, offline PWA submission, customer workflow steps, case messaging, CSAT, logo/branding, Form Builder forms.",
        "phase": 33,
        "dev_time": "4 days",
        "api_endpoints": ["/api/v1/portal-admin/tenants", "/api/v1/portal-admin/submissions", "/api/v1/portal/{slug}",
                          "/api/v1/portal/{slug}/account", "/api/v1/cases/{id}/messages"],
        "ai_dependency": "none",
    },
    {
        "category": "Admin",
    ...
    },
    {
        ...
        "path": "/hxwork",
        "label": "HxWork",
        "description": "Kanban and Sprint boards backed by Velaris cases — every card is a real case with stages, SLAs, and assignees. Sprints, velocity tracking, blocking relationships, and HxNexus board analysis.",
        "phase": 56,
        "dev_time": "4 days",
        "api_endpoints": [
    ...
    },
    {
        ...
        "path": "/hxmigrate",
        "label": "HxMigrate",
        "description": "Unified migration pipeline — upload a Pega/Camunda/Appian/ServiceNow export once and get a deployable Velaris application out. Five automatic stages: Scout scan → AI analysis → BPM generation → Orchestrator project → App package.",
        "phase": 54,
        "dev_time": "3 days",
        "api_endpoints": [
    ...
    },
    {
        ...
        "path": "/graph",
        "label": "HxGraph",
        "description": "Velaris native knowledge graph — live semantic graph of all case types, stages, forms, modules, and their relationships. Replaces graphify.",
        "phase": 41,
        "dev_time": "4 days",
        "api_endpoints": [
    ...
    },
    {
        ...
        "path": "/hxlogs",
        "label": "HxLogs",
        "description": "AI-driven unified log analyser — reads structlog output from all Velaris services, groups multi-line tracebacks with innermost frame highlighted, and sends selected errors to HxNexus for root-cause analysis, suggested fix, and related module identification.",
        "phase": 63,
        "dev_time": "1 day",
        "api_endpoints": [
    ...
    },
    {
        ...
        "path": "/sitemap",
        "label": "Site Map",
        "description": "This page — catalog of every module in Velaris.",
        "phase": 20,
        "dev_time": "1 day",
...
PHASES = [
    ...
    {"num": 41,  "name": "HxGraph — Velaris Native Knowledge Graph", "complete": True},
